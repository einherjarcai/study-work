 ...
 */
@Repository
public class WeiBoThemeInfoDao {
    @Autowired
     ...
     * @return
     */
    public List<Map<String,String>> getWeiBoThemeData(String theme, String department, String startdate, String enddate, String keyword, int page, int size) {
        BoolQueryBuilder boolquery = QueryBuilders.boolQuery();
        ...
        QueryBuilder termquery4 = QueryBuilders.termQuery("type", "7");
...
//                .must(termquery3)
        ...
        if (keyword != null) {
            QueryBuilder queryBuilder2 = QueryBuilders.matchQuery("news_title", keyword);
        ...
        if (hits.totalHits > 0) {
            for (SearchHit hit : hits) {
                ...
                map.put("content", String.valueOf(sourceData.get("news_title")));
     ...
     * @return
     */
    public int getWeiBoThemeTotal(String theme, String department, String startdate, String enddate, String keyword) {
        BoolQueryBuilder boolquery = QueryBuilders.boolQuery();
        QueryBuilder termquery1 = QueryBuilders.termQuery("theme", theme);
        QueryBuilder termquery2 = QueryBuilders.termQuery("department", department);
        QueryBuilder termquery3 = QueryBuilders.termQuery("level", "3");
